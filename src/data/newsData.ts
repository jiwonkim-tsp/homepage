...
export const newsData: INewData[] = [
  {
    ...
    content:
      "국토교통부는 9일 경기도 판교테크노벨리의 스타트업 캠퍼스에서 ‘스마트시티 넥스트 혁신기술 실증사업’ 협약식을 열고 4개 기술에 대한 사업 협약을 맺었습니다.",
  ...
  },
  {
    ...
    content:
      "서울 봉은사 경내 곳곳에 각종 데이터가 저장된 바코드, 대형 QR코드가 인쇄된 현수막이 설치되어 있습니다. 스마트폰으로 QR코드를 비추자 연꽃 위에 앉아있는 부처님이 눈 앞에 펼쳐집니다.",
  ...
  },
  {
    ...
    content:
      "담을 수 있는 정보가 한정되어 있고 수정이 번거로운 인쇄 명함의 단점을 개선할 수 있습니다. 명함을 인식해 사업 소개 영상을 띄우거나 전용 메타버스 공간으로 확장도 가능합니다.",
...
export const newsPageData: INewData[] = [
  {
    id: 1,
    press: "BBS NEWS",
    title:
